...
export const ApplicationName = 'eventapp';
...
let applicationPaths: ApplicationPathsType = {
  ...
  ApiAuthorizationClientConfigurationUrl: environment.api.base + `/_configuration/${ApplicationName}`,
  ...
  IdentityRegisterPath: environment.api.base + '/Identity/Account/Register',
  IdentityManagePath: environment.api.base + '/Identity/Account/Manage'
};
